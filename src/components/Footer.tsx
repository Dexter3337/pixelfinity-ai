      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm mb-6 max-w-sm">
              Transform your ordinary photos into extraordinary masterpieces with our advanced AI-powered image enhancement technology.
            </p>
        ...
        <div className="border-t border-gray-200/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} PixelEnhance. All rights reserved.
          </p>
